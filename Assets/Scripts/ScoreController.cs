...
public class ScoreController : MonoBehaviour {
    ...
    Vector3[] playerStartRot = { new Vector3(0, 0, 0), new Vector3(0, 130, 0), new Vector3(0, -130, 0) };
    ...
    public void Respawn()
    {
        GameObject t1 = Instantiate(p1, playerStartPos[0], Quaternion.Euler(playerStartRot[0]));
        iManager.pc1 = t1.GetComponent<PlayerController>();
        GameObject t2 = Instantiate(p2, playerStartPos[1], Quaternion.Euler(playerStartRot[1]));
        iManager.pc2 = t2.GetComponent<PlayerController>();
        GameObject t3 = Instantiate(p3, playerStartPos[2], Quaternion.Euler(playerStartRot[2]));
